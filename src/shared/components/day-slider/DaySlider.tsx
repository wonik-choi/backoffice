    ...
    <div className="w-full">
      ...
      >
        ...
        {Array.from({ length: selectedValue?.length || 0 }, (_, index) => (
          <Slider.Thumb
            key={index}
            className="block size-[1.8rem] rounded-full border border-primary/50 bg-background shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
          >
