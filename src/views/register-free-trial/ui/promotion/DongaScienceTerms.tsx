  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[0.8rem] items-start w-full px-4">
        ...
        <ul>
          <li className="text-susimdal-text-subtle text-[1.2rem] leading-[1.6rem]">제공받는 자: (주)동아사이언스</li>
          <li className="text-susimdal-text-subtle text-[1.2rem] leading-[1.6rem]">제공 항목: 성함, 연락처, 주소</li>
          <li className="text-susimdal-text-subtle text-[1.2rem] leading-[1.6rem]">
