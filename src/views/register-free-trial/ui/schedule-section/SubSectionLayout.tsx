...
export const SubSectionLayout = ({ title, subTitle, delay, children }: ScheduleSectionLayoutProps) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col gap-[1rem] mobile:gap-[1.5rem] justify-start items-start"
    >
      ...
      {subTitle && (
        <motion.p
          ...
          className={cn(
            'text-[1.2rem] mobile:text-[1.4rem] text-black font-normal',
            isCorrectSelectWeek && 'text-susimdal-text-primary'
          )}
        >
          {subTitle}
        </motion.p>
