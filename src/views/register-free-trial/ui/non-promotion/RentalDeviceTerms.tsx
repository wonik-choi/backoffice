...
export const RentalDeviceTerms = ({ openState, setOpenState, agreeTerms, isPending }: DeviceRentalTermsProps) => {
  return (
    <DrawerTermLayout
      openState={openState}
    ...
    >
      <div className="flex flex-col gap-[0.8rem] items-start w-full px-4">
        <h3 className="font-medium text-[1.3rem]">개인정보 수집 및 이용 동의</h3>
