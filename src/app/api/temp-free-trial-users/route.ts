...
import type { GetTempUsersRequestDto } from '@/entities/temp-user/models/repository';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const requestDto: GetTempUsersRequestDto = {
    ...
    const result = await tempUserRepository.getTempUsers(requestDto, { headers });
